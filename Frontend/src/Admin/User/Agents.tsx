...
const Agents = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const res = await axios.get(`${URL}/api/admin/getallusers?options=${option}&page=${page}&limit=${limit}&usertype=AGENT&name=${name}`, {
                headers: {
        ...
        <div className='w-full h-auto flex flex-col lg:flex-row mt-[8vh]' >
            ...
            <div className='w-full flex-1 bg-gray-100'>
                <div className="p-4 sm:p-6 bg-gray-100 overflow-x-auto">
                    <h1 className="text-2xl font-medium mb-4 text-gray-700 capitalize"><span className="text-gray-500 cursor-pointer" onClick={() => navigate('/admin/dashboard')}>Dashboard</span> / All Agents</h1>
