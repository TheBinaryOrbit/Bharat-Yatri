...
import { auth , ride } from "../../lib/types";
        ...
        <div className='w-full h-auto flex flex-col lg:flex-row mt-[10vh]' >
            ...
            <div className='w-full flex-1 bg-gray-100'>
                <div className="p-4 sm:p-6 bg-gray-100 overflow-x-auto">
                    <h1 className="text-2xl font-medium mb-4 text-gray-700 capitalize"><span className="text-gray-500 cursor-pointer" onClick={() => navigate('/admin/dashboard')}>Dashboard</span> / Rides / Duty</h1>
                        ...
                        <table className="min-w-full text-sm text-gray-700">
                            <thead className="bg-blue-600 text-white text-left text-base font-semibold">
                                <tr>
                                    ...
                                    <th className="py-3 px-6">Commission Fee</th>
                                    <th className="py-3 px-6">TripType</th>
                                </tr>
                            </thead>
                            <tbody>
                                {data.length === 0 ? (
                                    ...
                                    data.map((ride : ride, i) => (
                                        ...
                                        >
                                            ...
                                            <td className="py-4 px-6">{ride.commissionFee}</td>
                                            <td className="py-4 px-6">{ride.tripType}</td>
                                        </tr>
                                    ))
                                )}
                            </tbody>
